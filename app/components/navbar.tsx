      ...
      {isOpen && (
        ...
        >
          ...
          <li>
            <a
              href="/auth"
              className="block text-center py-2 px-4 bg-gradient-to-r from-pink-500 to-purple-600 rounded-xl text-white font-semibold shadow hover:opacity-90 transition"
              onClick={() => setIsOpen(false)}
            >
              🔐 Login / Signup
            </a>
